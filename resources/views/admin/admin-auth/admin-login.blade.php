        ...
        <div class="m-grid__item m-grid__item--fluid	m-login__wrapper">
            <div class="m-login__container">
                <div class="m-login__logo">
                    <a href="#">
                        <img src="{{asset('images/logo/logo.png')}}" title="Logo">
                    </a>
                </div>
                <div class="m-login__signin">
                    ...
                    <form class="m-login__form m-form" action="{{ route('admin.login.submit') }}" method="POST">
                        ...
                        <div class="form-group m-form__group">
                            <input  class="form-control m-input" type="text" placeholder="Username" name="username" value="{{ old('username') }}" required autofocus >
                        </div>
                        <div class="form-group m-form__group">
                        ...
                        <div class="m-login__form-action">
                            <button style="-webkit-border-radius: 50px;-moz-border-radius: 50px;border-radius: 50px;" type="submit" id="m_login_signin_submit" class="btn btn-focus m-btn m-btn--pill m-btn--custom m-btn--air m-login__btn m-login__btn--primary custom-button">Sign In</button>
                        </div>
                    </form>
                </div>
            </div>
