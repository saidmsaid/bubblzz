                    ...
                    <div class="m-portlet__head-tools">
                        <ul class="m-portlet__nav">
                            <li class="m-portlet__nav-item">
                                <a href="{{route('subcategory.create')}}" class="btn m-btn--pill    btn-success">
												<span>
                ...
                <div class="m-portlet__body">
                    ...
                    <table class="table table-striped- table-bordered table-hover table-checkable" id="m_table_1">
                        ...
                        <tr>
                            ...
                            <th>Subcategory Arabic Name</th>
                            <th>Subcategory Description</th>
                            <th>Subcategory Arabic Description</th>
                        ...
                        @foreach($categories as $category)
                            <tr class="gradeX">
                                ...
                                <td class="center text-center">
                                    <a title="Edit" href="{{route('subcategory.edit', $category->id)}}" class="btn m-btn--air btn-primary custom-padding"><i class=" flaticon-edit-1"></i></a>
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                             <p>Are you sure to delete this subcategory? If yes, It will delete all products in this subcategory</p>
                                            </div>
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-primary" data-dismiss="modal">Close</button>
                                                <form style="display: inline-block" action="{{route('subcategory.destroy',$category->id)}}" method="post">
                                                    @csrf
