    ...
    <div class="m-grid__item m-grid__item--fluid m-wrapper">
        ...
        @include('admin.includes.message')
            ...
            <div class="m-portlet">
                ...
                <!--begin::Form-->
                <form enctype="multipart/form-data" class="form-horizontal" method="post" action="{{route('mails.store')}}" name="basic_validate" id="basic_validate" novalidate="novalidate">
                    @csrf
