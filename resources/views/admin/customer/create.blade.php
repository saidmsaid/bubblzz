    ...
    <div class="m-grid__item m-grid__item--fluid m-wrapper">
        ...
        <!--begin::Portlet-->
            <div class="m-portlet">
                ...
                <!--begin::Form-->
                <form class="form-horizontal" method="post" action="{{route('customer.store')}}" name="basic_validate" id="imageSlider_validate" novalidate="novalidate">
                    @csrf
                    <div class="control-group">
                        <label class="control-label">Name *</label>
                        <div class="controls">
                            <input class="custom-input" type="text" name="name" id="required">
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label">Email </label>
                        <div class="controls">
                            <input class="custom-input" type="text" name="email" id="required">
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label">Mobile *</label>
                        <div class="controls">
                            <input class="custom-input" type="text" name="mobile" id="required">
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label">Address 1 *</label>
                        <div class="controls">
                            <input class="custom-input" type="text" name="address1" id="required">
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label">Address 2</label>
                        <div class="controls">
                            <input class="custom-input" type="text" name="address2" id="required">
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label">Address 3</label>
                        <div class="controls">
                            <input class="custom-input" type="text" name="address3" id="required">
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label">Address 4</label>
                        <div class="controls">
                            <input class="custom-input" type="text" name="address4" id="required">
                        </div>
                    </div>
                    <div class="control-group">
