...
// > Top cart list Show Hide function by = custom.js =================== //	
	 function cart_block(){
		...
		jQuery( ".cart-dropdown-item-wraper" ).slideToggle( "slow" );
	  	jQuery( ".wish-dropdown-item-wraper" ).hide( "slow" );
	  });  
	 }
	 
	  function wish_block(){
		jQuery('.wish-btn').on('click', function () { 
		jQuery( ".wish-dropdown-item-wraper" ).slideToggle( "slow" );
		jQuery( ".cart-dropdown-item-wraper" ).hide( "slow" );
	  });  
	 }
// > Nav submenu show hide on mobile by = custom.js
